...
class Principal():
    ...
    def __init__(self,master):
        ...
        self.Buscar=Button(self.boton,command=self.load,text="Buscar Proveedor",background="white")
        self.Buscar.grid(row=3,column=5)
        self.Pedido=Button(self.boton,text="Validar Pedido",background="white")
        self.Pedido.grid(row=4,column=1)
        self.Fecha=Button(self.boton,text="Agregar Fecha",background="white")
